...
protected:
   ...
   */
  bool runSingleIteration(std::chrono::time_point<std::chrono::high_resolution_clock>start_);
   ...
   * @return
   */
  bool computeOptimizedCost(std::chrono::time_point<std::chrono::high_resolution_clock> start_);
